...
venue: "Columbia University (Butler Library, Room 203)"        # brief name of host site without address (e.g., "Euphoric State University")
address: "Butler Library, 535 West 114th Street, room 203"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
country: "us"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes)
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
latitude: "40.806180"     # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-73.963330"    # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "January 16-17, 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Monica Thieu", "Brian Luna Lucero", "John Pellman", "Jonathan Reeve"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Jonathan Reeve", "Alex Gil", "Dustin King", "Sydney Bolim Son", "Brian Luna Lucero", "Aaron Limoges"]
...
<h2 id="general">Software Carpentry Curriculum Information
</h2>
...
<p id="requirements">
  ...
  When directed, participants can log into Socrative [here](https://b.socrative.com/login/student/) to answer in-class check-in questions.
</p>
